...
function BestSeller() {
        ...
        const filterTopSellingProducts = () => {
            ...
            productDetails.forEach((product) => {
                product.colorDetails.forEach((colorDetail) => {
                    if (colorDetail.top_selling === "true") {
    ...
    const addCartFunc1 = async () => {
        try {
            ...
            console.log("Sudhanshi ki gf", resultcart.data.other)
    ...
    return (
        <>
            ...
            <div className='text-center'>
                <button value="top_selling" className='hidden md:block text-center mx-auto border-2 w-40 py-2 border-black hover:text-red-300 hover:border-red-300' onClick={(e) => callingcatfilter(e.target.value)}>
                    Load More
                </button>
            </div>
            <ToastContainer
